...
= 3.4.5 =
* Added the Online Active Users block to display the active user count in the WordPress block editor.
* Confirmed compatibility with WordPress 7.1. Upgrade immediately.
